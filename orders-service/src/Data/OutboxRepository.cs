...
namespace OrdersService.Data
{
    ...
    {
        public async Task InsertPaymentRequestedAsync(NpgsqlConnection conn, NpgsqlTransaction tx, Guid orderId,
            string payloadJson, CancellationToken ct)
        {
            const string sql = """

                                           INSERT INTO outbox_messages (event_id, aggregate_id, event_type, payload)
                                           VALUES (gen_random_uuid(), @orderId, 'PaymentRequested', @payloadJson::jsonb)
